...
_These are the links of the temporary home of the mod while the mod owners are unable to update the official repo._
...
The title screen and logs will _mostly_ verify that the mod is working before you load into the game.
