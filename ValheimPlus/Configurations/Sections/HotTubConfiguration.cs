...
{
    public class HotTubConfiguration : BaseConfig
    {
        private const string Section = "HotTub";
        ...
        public override void Bind(ConfigFile config)
        {
            ...
            infiniteFuelEntry = Bind(config, Section, "infiniteFuel", false,
                "If set to true, the hot tub will stay at max fuel level, without consuming any fuel.");
